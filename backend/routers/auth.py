...
async def register(
    ...
    telephone: Optional[str] = Form(None), role: str = Form("usager"),
    carte_identite: UploadFile = File(...),
    justificatif_domicile: UploadFile = File(...),
    ...
    ci_url = save_file(carte_identite, "documents")
    jd_url = save_file(justificatif_domicile, "documents")
    user = User(
        ...
        carte_identite_url=ci_url, justificatif_domicile_url=jd_url,
